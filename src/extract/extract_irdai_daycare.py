...
# Set up logging
log_file = LOG_DIR / "extract_irdai_daycare.log"
logging.basicConfig(
    filename=log_file,
    level=logging.INFO,
...
def extract_irdai_daycare():
    source_file_csv = RAW_DIR / "irdai_daycare.csv"
    source_file_xlsx = RAW_DIR / "irdai_daycare.xlsx"
    ...
    if not source_file:
        logging.warning("Source file missing: irdai_daycare")
        print("Warning: Source file missing: irdai_daycare")
        return
    ...
    try:
        ...
        output_file = PROCESSED_DIR / "irdai_daycare_extracted.csv"
