...
# Set up logging
log_file = LOG_DIR / "extract_gipsa.log"
logging.basicConfig(
    filename=log_file,
    level=logging.INFO,
...
def extract_gipsa():
    source_file_csv = RAW_DIR / "gipsa.csv"
    source_file_xlsx = RAW_DIR / "gipsa.xlsx"
    ...
    if not source_file:
        logging.warning("Source file missing: gipsa")
        print("Warning: Source file missing: gipsa")
        return
    ...
    try:
        ...
        output_file = PROCESSED_DIR / "gipsa_extracted.csv"
