...
# Set up logging
log_file = LOG_DIR / "extract_pmjay_hbp.log"
logging.basicConfig(
    filename=log_file,
    level=logging.INFO,
...
def extract_pmjay_hbp():
    source_file_csv = RAW_DIR / "pmjay_hbp.csv"
    source_file_xlsx = RAW_DIR / "pmjay_hbp.xlsx"
    ...
    if not source_file:
        logging.warning("Source file missing: pmjay_hbp")
        print("Warning: Source file missing: pmjay_hbp")
        return
    ...
    try:
        ...
        output_file = PROCESSED_DIR / "pmjay_hbp_extracted.csv"
